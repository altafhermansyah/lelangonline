                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link fw-bold {{ request()->url() === route('login') ? 'active' : ' ' }}"
                                        href="{{ route('login') }}">{{ __('Login') }} Staff</a>
                                </li>
                            @endif
                            <li class="nav-item">
                                <a class="nav-link fw-bold {{ request()->url() === route('masyarakat.view') ? 'active' : ' ' }}"
                                    href="{{ route('masyarakat.view') }}">Login User</a>
                            </li>
